...
Finally, the model prints the updated _X_ and _Y_ coordinates to an output file. See <<Output>> for details of the resulting file format.
...
=== [[Output]]Writing results to file
